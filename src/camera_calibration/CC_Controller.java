	...
	// FXML buttons
		...
		protected void startCamera()
		{
			if (!this.cameraActive)
			{
				...
				this.capture.open(0);
//				capture.open("C:\\Users\\Milan\\Desktop\\calibration\\GOPR3984.MP4");
		 ...
		 */
		@FXML
		protected void takeSnapshot() throws FileNotFoundException
		{
		 ...
		 * @throws FileNotFoundException 
		 */
		private void calibrateCamera() throws FileNotFoundException
		{
			...
			intrinsic.put(1, 1, 1);
			// calibrate!
			double error = Calib3d.calibrateCamera(objectPoints, imagePoints, savedImage.size(), intrinsic, distCoeffs, rvecs, tvecs);
			System.out.println("The camera calibration error is: " + error);
			this.isCalibrated = true;
			MatSerializer.saveStringToFile(MatSerializer.matToJson(intrinsic), "resources/camera/cameraMatrix.json");
