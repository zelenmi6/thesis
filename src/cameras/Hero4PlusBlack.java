...
public class Hero4PlusBlack extends AbstractCamera {
	...
	public Hero4PlusBlack(double initialFovVertical, double initialFovHorizontal, int initialFps) {
		super(initialFovVertical, initialFovHorizontal, initialFps);
		this.cameraName = "HERO3+ Black Edition";
	}
	
	public Hero4PlusBlack(FieldOfViewInterface initialFieldOfView, int initialFps) throws Exception {
