...
//	}
	...
	public void testTime() {
		...
		for (int i = 0; i < 100; i ++) {
			...
			dao.getIdContainingPoint(r.nextInt(high1 - low1) + low1, r.nextInt(high1 - low1) + low1);
			long end = System.currentTimeMillis();
			System.out.println("Test finished in: " + (end - start) + " MilliSeconds");
		}
	}
